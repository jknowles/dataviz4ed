...
library(knitr)
opts_chunk$set(fig.width=8,fig.height=5.5,message=FALSE,error=FALSE,warning=FALSE,echo=TRUE,dev="svg",comment=NA,out.width="750px",out.height="550px", fig.align='center')
library(eeptools)
library(ggplot2)
library(ggthemes)
require('hexbin')
