...
```{r plot2, fig.height=5.5, fig.width=8.5,fig.align="center",out.width="750px",out.height="480px",echo=FALSE}
...
qplot(speed,quality,data=viz,geom="point",color=factor(web),size=I(4))+
  coord_cartesian(x=c(0,11),y=c(0,11))+theme_dpi()+geom_text(aes(label=techs),color="black",vjust=1.4,hjust=1)+theme(axis.text=element_blank(),axis.ticks=element_blank(),legend.position="bottom")+
...
```{r studentexample,echo=FALSE,out.width='300px',out.height='250px'}
qplot(attday,readSS,
